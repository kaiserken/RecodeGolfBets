   ...
   async _setdata() {
     try {
       var value  = await AsyncStorage.multiSet([
         ...
         ["player2Score", JSON.stringify([2,5,7,2,5,7,2,5,7,2,5,7,4,5])],
         ["player3Score", JSON.stringify([5,3,4,5,3,4,5,3,4,5,3,4,3,5])],
         ["player4Score", JSON.stringify([3,6,3,3,6,3,3,6,3,3,6,3,6,4])],
         ["player1NetScore",JSON.stringify([3,6,3,3,6,3,3,6,3,3,6,3,4,5])],
         ["player2NetScore",JSON.stringify([5,3,4,5,3,4,5,3,4,5,3,4,5,4])],
         ["player3NetScore",JSON.stringify([2,5,7,2,5,7,2,5,7,2,5,7,6,4])],
         ["player4NetScore",JSON.stringify([4,3,4,4,3,4,4,3,4,4,3,4,5,3])],
