   ...
   async _setdata() {
     try {
       var value  = await AsyncStorage.multiSet([
         ...
         ["player1Score", JSON.stringify([4,3,4,4,3,4,4,3,4,4,3,4])],
         ["player2Score", JSON.stringify([2,5,7,2,5,7,2,5,7,2,5,7])],
         ["player3Score", JSON.stringify([5,3,4,5,3,4,5,3,4,5,3,4])],
         ["player4Score", JSON.stringify([3,6,3,3,6,3,3,6,3,3,6,3])],
         ["player1NetScore",JSON.stringify([3,6,3,3,6,3,3,6,3,3,6,3])],
         ["player2NetScore",JSON.stringify([5,3,4,5,3,4,5,3,4,5,3,4])],
         ["player3NetScore",JSON.stringify([2,5,7,2,5,7,2,5,7,2,5,7])],
         ["player4NetScore",JSON.stringify([4,3,4,4,3,4,4,3,4,4,3,4])],
         ["holeNumber",JSON.stringify(13)],
         ["name","hole"],
         ...
         ["auto9", JSON.stringify(false)],
         ["auto18", JSON.stringify(false)],
